...
class MeshMetadataSerializer final : public AssetMetadataSerializer
{
  public:
    virtual Ref<EditorAssetMetadata> Deserialize(const IDeserializer &data, const Path &assetPath) override
    {
        ...
        auto materialMetadata = CreateRef<EditorAssetMetadata>(handle, AssetType::Mesh, dependencies, assetPath);
