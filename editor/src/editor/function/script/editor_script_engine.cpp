...
void EditorScriptEngine::LoadRuntimeCoreAssemblyImpl()
{
    ...
    if (std::filesystem::exists(pdbPath))
    {
        ...
        mono_debug_open_image_from_memory(runtimeDomain->GetCoreAssemblyImage(), pdbFileData.Data<uint8_t>(), pdbFileData.Size<uint8_t>());
    }
}
...
void EditorScriptEngine::LoadRuntimeAppAssemblyImpl()
{
    ...
    {
        ScopedBuffer pdbFileData = FileSystem::ReadBytes(pdbPath);
        mono_debug_open_image_from_memory(runtimeDomain->GetAppAssemblyImage(), pdbFileData.Data<uint8_t>(), pdbFileData.Size<uint8_t>());
    }
}
