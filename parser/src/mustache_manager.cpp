...
std::string MustacheManager::RenderHeaderFile(const HeaderMustacheFormat &format)
{
    mustache::data data;
    data.set("module_name", format.module_name);
    return header_template.render(data);
}
