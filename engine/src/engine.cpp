...
Ref<AssetManager> Engine::assetManager;
...
Ref<AssetManager> Engine::GetAssetManager() { return assetManager; }
...
void Engine::SetAssetManager(const Ref<AssetManager> &manager)
{
