...
{
    if (auto it = keyState.find((uint32)key); it != keyState.end())
        return it->second;
    return false;
}
...
{
    if (auto it = keyPressed.find((uint32)key); it != keyPressed.end())
        return it->second;
    return false;
}
bool Input::IsKeyReleased(KeyCode key)
{
    if (auto it = keyReleased.find((uint32)key); it != keyReleased.end())
        return it->second;
    return false;
}
...
{
    if (auto it = mouseButtonState.find((uint32)button); it != mouseButtonState.end())
        return it->second;
    return false;
}
...
{
    if (auto it = mouseButtonPressed.find((uint32)button); it != mouseButtonPressed.end())
        return it->second;
    return false;
}
bool Input::IsMouseButtonReleased(MouseButton button)
{
    if (auto it = mouseButtonReleased.find((uint32)button); it != mouseButtonReleased.end())
        return it->second;
    return false;
}
